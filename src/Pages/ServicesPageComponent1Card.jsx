...
const ServicesPageComponent1Card = () => {
  return (
    <div className="container relative z-10 pt-10 mx-auto pb-28">
      <div className="flex items-center justify-center">
        <div className="grid w-5/6 h-full grid-cols-1 gap-10 lg:grid-cols-2">
          {services.map((service, index) => (
            <article
              key={index}
              className="p-6 transition duration-300 shadow-lg sm:p-8 border-x-2 border-Text rounded-2xl bg-Black hover:shadow-Accent2"
            >
              <span className="text-White">{service.icon}</span>

              <a href="#">
                <h3 className="mt-6 text-3xl font-medium font-title text-Accent2">
                  {service.title}
                </h3>
              </a>

              <p className="mt-4 text-md font-para text-Text">
              ...
              <button>
                <div className="relative px-6 py-1 mt-8 transition duration-300 border-x-2 hover:border-Text rounded-xl bg-Accent2 hover:bg-Black">
...
export default ServicesPageComponent1Card;
